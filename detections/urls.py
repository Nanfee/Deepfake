...
urlpatterns = [
    ...
    path('low_resolution_detect/', views.low_resolution_detect, name='low_resolution_detect'),
    path('temporal/', views.temporal, name='temporal'),
    path('temporal_detect/', views.temporal_detect, name='temporal_detect'),
    path('target/', views.target, name='target'),
    path('target_detect/', views.target_detect, name='target_detect'),
